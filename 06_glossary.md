...
A scale development method where the assumption is that the participants' responses or overall score on a measure are a linear combination of their true ability plus random error. The goal in CTT is to get as close to the true score as possible by minimizing noise. (test citation 2)
